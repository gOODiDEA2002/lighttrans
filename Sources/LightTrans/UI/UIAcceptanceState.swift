    ...
    static func make(for state: UIAcceptanceState) -> UIAcceptanceSettingsSnapshot {
        ...
        case .settingsAPIIdle:
            return .init(
                ...
                apiKey: "sk-acceptance-state-idle-0001",
                maxTokensText: "2000",
        ...
        case .settingsAPITesting:
            return .init(
                ...
                apiBaseURL: "https://api.openai.com/v1",
                modelName: "deepseek-chat",
                apiKey: "sk-acceptance-state-test-0002",
                maxTokensText: "2000",
                literalTemplate: validLiteral,
                rewriteTemplate: validRewrite,
                testStatus: .testing
        ...
        case .settingsAPISuccess:
            return .init(
                ...
                apiBaseURL: "https://api.openai.com/v1",
                modelName: "deepseek-chat",
                apiKey: "sk-acceptance-state-pass-0003",
                maxTokensText: "2000",
                literalTemplate: validLiteral,
                rewriteTemplate: validRewrite,
        ...
        case .settingsAPILongError:
            return .init(
                ...
                apiBaseURL: "https://api.openai.com/v1",
                modelName: "deepseek-chat",
                apiKey: "sk-acceptance-state-fail-0004",
                maxTokensText: "2000",
                literalTemplate: validLiteral,
                rewriteTemplate: validRewrite,
        ...
        case .settingsTemplatesValid:
            return .init(
                ...
                apiBaseURL: "https://api.openai.com/v1",
                modelName: "deepseek-chat",
                apiKey: "sk-acceptance-template-valid-5",
                maxTokensText: "2000",
                literalTemplate: validLiteral,
                rewriteTemplate: validRewrite,
                testStatus: .idle
        ...
        case .settingsTemplatesInvalid:
            return .init(
                ...
                apiBaseURL: "https://api.openai.com/v1",
                modelName: "deepseek-chat",
                apiKey: "sk-acceptance-template-miss-6",
                maxTokensText: "2000",
                literalTemplate: """
        ...
        default:
            return .init(
                ...
                apiBaseURL: "https://api.openai.com/v1",
                modelName: "deepseek-chat",
                apiKey: "sk-acceptance-default-state-0",
                maxTokensText: "2000",
                literalTemplate: validLiteral,
                rewriteTemplate: validRewrite,
                testStatus: .idle
...
extension UIAcceptanceHistorySnapshot {
    static func make(for state: UIAcceptanceState) -> UIAcceptanceHistorySnapshot {
        ...
        let longRecord = HistoryRecord(
            ...
            time: "2026-08-20T17:35:02+08:00",
            device: "Andy-MacBook-Pro-Office-Device-Name-Very-Long-For-UI-Acceptance",
